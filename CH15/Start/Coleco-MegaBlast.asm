...
ME1:
    ...
    ADD A,4     ; add four
    CP 16       
    JR NZ,ME4   ; if we have reached 16 we need to move
...
ME5:
    ...
    LD A,(IX+0) ; get current Y position
    INC A ; fixed increase for now
    CP 150
    JR C,ME3
    ; enemy has reached the bottom of the screen
    ; check whether the enemy has hit the player ship
    LD A,(SPRTBL+1)
    SUB 14 ; fixed width of enemy at the moment
    CP (IX+1)
    JR NC, ME7
...
ME3:
    ...
    PUSH DE
    LD HL,0E0Eh ; set our meteor size at 14x14 
                ; - will change per enemy type later
